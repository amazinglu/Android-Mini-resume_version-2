...
public class Constants {
    ...
    public static final ParcelUuid DEVICE_INFORMATION_SERVICE_UUID =
            ParcelUuid.fromString("0000180a-0000-1000-8000-00805f9b34fb");
    public static final ParcelUuid PARABEACON_SERVICE_UUID =
            ParcelUuid.fromString("a3c87500-8ed3-4bdf-8a39-a01bebede295");
    ...
    public static final String BEACON_FW = "firmware version";
    public static final String BEACON_HW = "hardware version";
    public static final String BEACON_SN = "serial number";
    public static final String BEACON_MN = "manufacturer";
    public static final String BEACON_MD = "model";
    public static final String FIRMWARE_UPDATE_URL = "firmware update url";
    public static final String FIRMWARE_UPDATE_REVISION = "firmware update revision";
}
