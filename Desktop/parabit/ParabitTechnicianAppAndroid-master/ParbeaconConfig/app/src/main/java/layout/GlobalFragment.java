...
import com.parabit.parabeacon.app.tech.dialogs.ChangePasswordDialog;
...
public class GlobalFragment extends BeaconTabFragment {
    ...
    private String beaconFirmware;
    private String beaconHardware;
    ...
    public void updateInformation(final Bundle bundle) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                String beaconSerial = bundle.getString(Constants.BEACON_SN);
                if (beaconSerial != null) {
                    GlobalFragment.this.beaconSerial = beaconSerial;
                }

                String beaconFirmware = bundle.getString(Constants.BEACON_FW);
                if (beaconFirmware != null) {
                    GlobalFragment.this.beaconFirmware = beaconFirmware;
                }

                String beaconHardware = bundle.getString(Constants.BEACON_HW);
                if (beaconFirmware != null) {
                    GlobalFragment.this.beaconHardware = beaconHardware;
                }

                String beaconModel = bundle.getString(Constants.BEACON_MD);
                if (beaconFirmware != null) {
                    GlobalFragment.this.beaconModel = beaconModel;
                }
    ...
    private void setUpGlobalInformation(View v) {
        ...
        ((TextView) v.findViewById(R.id.beacon_serial)).setText(beaconSerial.trim());
        ((TextView) v.findViewById(R.id.beacon_firmware)).setText(beaconFirmware);
        ((TextView) v.findViewById(R.id.beacon_hardware)).setText(beaconHardware);
        ((TextView) v.findViewById(R.id.beacon_model)).setText(beaconModel);
