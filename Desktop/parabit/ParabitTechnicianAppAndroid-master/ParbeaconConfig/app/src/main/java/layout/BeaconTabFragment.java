...
import com.parabit.parabeacon.app.tech.BaseFragment;
import com.parabit.parabeacon.app.tech.Constants;
import com.parabit.parabeacon.app.tech.MainApplication;
 ...
 */
public abstract class BeaconTabFragment extends BaseFragment {
    public String name;
    protected ConfigurationListener configurationListener;
    protected ExecutorService executor;

    private String txPower;
    private String oldTxPower;

    private String advTxPower;

    private String advInterval;
    private String oldAdvInterval;
    ...
    public AuthManager getUserUtils(){
    ...
    public void updateInformation(Bundle bundle) {
        ...
        String serialNumber = bundle.getString(Constants.BEACON_SN);
    ...
    private void setUpRadioTxPower(View v) {
        if (txPower != null) {
            ...
            oldTxPower = txPower;
            txPowerView.setText(oldTxPower);
            ...
            seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onStopTrackingTouch(SeekBar seekBar) {
                    BeaconTabFragment.this.saveChanges();
                    Map<String, String> props = new HashMap<>();
                    props.put(Keys.SERIAL_NUMBER,serialNumber);
                    props.put(Keys.NEW_VALUE,txPower);
                    props.put(Keys.OLD_VALUE,oldTxPower);
                    oldTxPower = txPower;
                    ApplicationLogger.logEvent(Events.TX_CHANGED,props);
                    UiUtils.showToast(getActivity(),"Radio Tx Power updated successfully");
                }
                ...
                public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                    ...
                    txPower = Integer.toString(newValue);
                    txPowerView.setText(txPower);
                    BeaconTabFragment.this.setTxPower(newValue);
                }
            });
        }
    }
    ...
    private void setUpAdvertisingInterval(View v) {
        if (advInterval != null) {
            ...
            oldAdvInterval = advInterval;
            advIntervalView.setText(advInterval);
            final SeekBar advInterSeekBar = (SeekBar) v.findViewById(R.id.adv_interval_seek_bar);
            advInterSeekBar.setMax(9);
            int progress = (Integer.parseInt(advInterval)-1)/100;
            ...
            advInterSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                    ...
                    if (progress >= 0 && progress <= advInterSeekBar.getMax() + 1) {
                        advIntervalView.setText(Integer.toString(progress*100));
                ...
                public void onStopTrackingTouch(SeekBar seekBar) {
                    ...
                    Map<String, String> props = new HashMap<>();
                    props.put(Keys.SERIAL_NUMBER,serialNumber);
                    props.put(Keys.OLD_VALUE,oldAdvInterval);
                    props.put(Keys.NEW_VALUE,advInterval);
                    oldAdvInterval = advInterval;
                    ApplicationLogger.logEvent(Events.ADV_CHANGED,props);
                    UiUtils.showToast(getActivity(),"Adv interval updated successfully");
                }
            });
        }
    }
