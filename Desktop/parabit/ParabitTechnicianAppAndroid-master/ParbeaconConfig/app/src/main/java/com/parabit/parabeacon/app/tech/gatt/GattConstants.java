...
public class GattConstants {
    ...
    public static final String CHAR_FW_VERSION = "00002a26-0000-1000-8000-00805f9b34fb";
    public static final String CHAR_HW_VERSION = "00002a27-0000-1000-8000-00805f9b34fb";
    public static final String CHAR_SERIAL_NUMBER = "00002a25-0000-1000-8000-00805f9b34fb";
    public static final String CHAR_MANUFACTURER = "00002a29-0000-1000-8000-00805f9b34fb";
    public static final String CHAR_MODEL = "00002a24-0000-1000-8000-00805f9b34fb";
    ...
    static {
        ...
        attributes.put(CHAR_FW_VERSION, "Firmware version");
        attributes.put(CHAR_HW_VERSION, "Hardware version");
        attributes.put(CHAR_SERIAL_NUMBER, "Serial number");
        attributes.put(CHAR_MANUFACTURER, "Manufacturer");
        attributes.put(CHAR_MODEL, "Model");
    }
